...
| Translation work safely persisted | **9723 / 21041 rows** |
| file_ids with complete persisted translation | **100 / 241** |
| YPK_GTT | **36 / 36 complete** |
| OHD | **1 / 1 complete** |
| LOOSE_OLANG | **14 / 14 complete** |
| STAGEDAT_OLANG | **46 / 46 complete** |
| SLOT_OLANG | **3 / 144 complete** |
...
- SLOT_OLANG: **11 rows / 3 complete file_ids**.
...
## Next resource class
`SLOT_OLANG` — **3 / 144 complete**. Continue with the next unstarted SLOT file_id after checking for newer concurrent mappings; prefer smaller files first for durable checkpoints.

## Last safe checkpoint
- Safe translation total: **9723 rows / 100 complete file_ids**.
- STAGEDAT_OLANG: **46 / 46 complete**.
- SLOT_OLANG: **3 / 144 complete**.
- Latest completed artifact: `sol_translation_mappings/SLOT_OLANG/5D1708FB.json`.
- Latest mapping commit: `c92b2c3f3152c3a7f0de49d810f138f3ff00ff0e`.
