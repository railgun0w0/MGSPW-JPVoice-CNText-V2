...
| Translation work safely persisted | **9804 / 21041 rows** |
| file_ids with complete persisted translation | **106 / 241** |
| YPK_GTT | **36 / 36 complete** |
| OHD | **1 / 1 complete** |
| LOOSE_OLANG | **14 / 14 complete** |
| STAGEDAT_OLANG | **46 / 46 complete** |
| SLOT_OLANG | **9 / 144 complete** |
...
- SLOT_OLANG: **92 rows / 9 complete file_ids**.
...
## Next resource class
`SLOT_OLANG` — **9 / 144 complete**. Continue with the next unstarted SLOT file_id after checking for newer concurrent mappings; prefer smaller files first for durable checkpoints.

## Last safe checkpoint
- Safe translation total: **9804 rows / 106 complete file_ids**.
- STAGEDAT_OLANG: **46 / 46 complete**.
- SLOT_OLANG: **9 / 144 complete**.
- Latest completed artifact: `sol_translation_mappings/SLOT_OLANG/5D3AFE0D.json`.
- Latest mapping commit: `3f66bb800a24f2899ac15d145d7d536591cdacb7`.
