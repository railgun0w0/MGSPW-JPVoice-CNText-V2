...
| Translation work safely persisted | **9826 / 21041 rows** |
| file_ids with complete persisted translation | **114 / 241** |
| YPK_GTT | **36 / 36 complete** |
| OHD | **1 / 1 complete** |
| LOOSE_OLANG | **14 / 14 complete** |
| STAGEDAT_OLANG | **46 / 46 complete** |
| SLOT_OLANG | **17 / 144 complete** |
...
- SLOT_OLANG: **114 rows / 17 complete file_ids**.
...
- `5DBA016B` — **5 rows, complete**. JPN crossover identities `RHAMPHOS`, `GEAR REX`, `LIOLAEUS`, `TIGREX`, `AIROU` are preserved exactly; international auxiliary substitutions such as `VELOCIPREY`, `RATHALOS`, and `FELYNE` are rejected. Mapping commit `d4caa7c3d0079b31f3c658de2435d3866b8d6ddc`.
...
## Next resource class
`SLOT_OLANG` — **17 / 144 complete**. Continue with the next unstarted SLOT file_id after checking for newer concurrent mappings; prefer smaller files first for durable checkpoints.

## Last safe checkpoint
- Safe translation total: **9826 rows / 114 complete file_ids**.
- STAGEDAT_OLANG: **46 / 46 complete**.
- SLOT_OLANG: **17 / 144 complete**.
- Latest completed artifact: `sol_translation_mappings/SLOT_OLANG/5DBA016B.json`.
- Latest mapping commit: `d4caa7c3d0079b31f3c658de2435d3866b8d6ddc`.
