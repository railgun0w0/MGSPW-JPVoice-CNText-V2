...
| Translation work safely persisted | **9800 / 21041 rows** |
| file_ids with complete persisted translation | **103 / 241** |
| YPK_GTT | **36 / 36 complete** |
| OHD | **1 / 1 complete** |
| LOOSE_OLANG | **14 / 14 complete** |
| STAGEDAT_OLANG | **46 / 46 complete** |
| SLOT_OLANG | **6 / 144 complete** |
...
- SLOT_OLANG: **88 rows / 6 complete file_ids**.
...
## Next resource class
`SLOT_OLANG` — **6 / 144 complete**. Continue with the next unstarted SLOT file_id after checking for newer concurrent mappings; prefer smaller files first for durable checkpoints.

## Last safe checkpoint
- Safe translation total: **9800 rows / 103 complete file_ids**.
- STAGEDAT_OLANG: **46 / 46 complete**.
- SLOT_OLANG: **6 / 144 complete**.
- Latest completed artifact: `sol_translation_mappings/SLOT_OLANG/5D3AF952.json`.
- Latest mapping commit: `aee19a3c2d55a8974fbe09b68c6a6945dfe7b61e`.
