...
| Translation work safely persisted | **9848 / 21041 rows** |
| file_ids with complete persisted translation | **118 / 241** |
| YPK_GTT | **36 / 36 complete** |
| OHD | **1 / 1 complete** |
| LOOSE_OLANG | **14 / 14 complete** |
| STAGEDAT_OLANG | **46 / 46 complete** |
| SLOT_OLANG | **21 / 144 complete** |
...
- SLOT_OLANG: **136 rows / 21 complete file_ids**.
...
- `5D3AF90D` — 4 rows; torture/self-termination clause, ruby, and ideographic-space placeholder follow JPN. Mapping `698e7f44165fc3f125c0c0260bc360cbbcaf45ee`.
- `5DA7D87B` — 7 rows; fixed uppercase shooting-range/location labels preserved. Mapping `7b5f2934e05e35bbf8f5f7f30e2bcfc79741f757`.
- `5DE2E8B4` — **6 rows complete**. Auxiliary rows were shifted; current-row JPN restored for prison/guard dialogue, including the ASCII space in `貴様 こんなものを！` and `次 連れてこい！`. Latest mapping commit `5119c9c121cd811d7a0cf4198b638ec0a339ded0`.
...
- Fixed JPN model/code/crossover/location identities are not normalized from auxiliary international naming.
...
## Next resource class
`SLOT_OLANG` — **21 / 144 complete**. Continue the next unstarted small SLOT after checking for newer concurrent mappings.

## Last safe checkpoint
- Safe translation total: **9848 rows / 118 complete file_ids**.
- SLOT_OLANG: **21 / 144 complete; 136 rows**.
- Latest completed artifact: `sol_translation_mappings/SLOT_OLANG/5DE2E8B4.json`.
- Latest mapping commit: `5119c9c121cd811d7a0cf4198b638ec0a339ded0`.
