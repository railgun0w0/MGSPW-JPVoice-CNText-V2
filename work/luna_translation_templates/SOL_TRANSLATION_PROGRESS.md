...
| Translation work safely persisted | **4725 / 21041 rows** |
| file_ids with complete persisted translation | **76 / 241** |
| YPK_GTT | **36 / 36 complete** |
| OHD | **1 / 1 complete** |
| LOOSE_OLANG | **14 / 14 complete** |
| STAGEDAT_OLANG | **25 / 46 complete** |
| SLOT_OLANG | **0 / 144** |
...
- Safe translation total: **4725 rows / 76 complete file_ids**.
- Resource-class checkpoint: **STAGEDAT_OLANG 25 / 46 complete**.
- Latest completed STAGEDAT mapping: `sol_translation_mappings/STAGEDAT_OLANG/LANG_VOCALOID.OLANG.json`.
- Latest STAGEDAT mapping commit: `1b52abaf8c875ad9d3675eaedcbf74df0e666f97`.
- Resume next at: **STAGEDAT_OLANG/LANG_ONLINE_ERROR.OLANG, unique_index 0**.
