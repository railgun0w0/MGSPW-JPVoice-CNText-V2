...
| Translation work safely persisted | **4375 / 21041 rows** |
| file_ids with complete persisted translation | **68 / 241** |
| YPK_GTT | **36 / 36 complete** |
| OHD | **1 / 1 complete** |
| LOOSE_OLANG | **14 / 14 complete** |
| STAGEDAT_OLANG | **17 / 46 complete** |
| SLOT_OLANG | **0 / 144** |
...
- Safe translation total: **4375 rows / 68 complete file_ids**.
- Resource-class checkpoint: **STAGEDAT_OLANG 17 / 46 complete**.
- Latest completed STAGEDAT mappings: `sol_translation_mappings/STAGEDAT_OLANG/LANG_V_THEATER020.OLANG.json` and `LANG_V_THEATER010.OLANG.json`.
- Resume next at: **STAGEDAT_OLANG/LANG_MYOUTER_UTIL.OLANG, unique_index 0**.
