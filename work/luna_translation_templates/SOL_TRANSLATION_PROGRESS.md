...
| Translation work safely persisted | **4828 / 21041 rows** |
| file_ids with complete persisted translation | **78 / 241** |
| YPK_GTT | **36 / 36 complete** |
| OHD | **1 / 1 complete** |
| LOOSE_OLANG | **14 / 14 complete** |
| STAGEDAT_OLANG | **27 / 46 complete** |
| SLOT_OLANG | **0 / 144** |
...
- STAGEDAT_OLANG: **803 rows / 27 file_ids complete**.
...
- Safe translation total: **4828 rows / 78 complete file_ids**.
- Resource-class checkpoint: **STAGEDAT_OLANG 27 / 46 complete**.
- Latest completed STAGEDAT mapping: `sol_translation_mappings/STAGEDAT_OLANG/LANG_DATAINSTALL.OLANG.json`.
- Latest STAGEDAT mapping commit: `664aa56d4aa21d15b7486e6f6084e49ad14a861d`.
- Resume next at: **STAGEDAT_OLANG/LANG_WEAPON_SHORT_NAME.OLANG, unique_index 0**.
